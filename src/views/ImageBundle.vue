<template>
    <div id="bundle-view" class="pa-2">
        ...
        <div v-if='bundle'>    
            <v-img :src ='$hostname+bundle.image' style="max-height: 70vh" contain/>
            <v-card
                class="mx-auto"
                outlined
            >
                ...
                <v-list-item-content>
                    ...
                    <v-list-item-title class="headline mb-1" style="white-space: initial">{{bundle.title}}</v-list-item-title>
                    <v-list-item-subtitle class="font-italic">{{bundle.media}}</v-list-item-subtitle>
                    <v-list-item-subtitle>{{bundle.story}}</v-list-item-subtitle>
                </v-list-item-content>
                </v-list-item>
            </v-card>
        </div>
